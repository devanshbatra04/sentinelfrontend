...
class Ui_BaseScreen(object):
    ...
    def on_click(self):
        ...
        # self.processCPUVal = str(self.processUsage['cpu_uasage'])
        # self.processDiskVal = str(self.processUsage['memory_usage'])
        self.runningAsUser = str(self.output['processes'][self.selectedRow]["User"])
